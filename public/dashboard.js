...
var netdataNoD3pie = true;
var netdataShowHelp = false;
...
(function (window, document, $, undefined) {
  ...
  NETDATA.seconds4human = function (seconds, options) {
    ...
    if (seconds > 1) {
      strings.push(
        Math.floor(seconds).toString() + options.space + options.seconds
      );
    } else if (seconds === 1) {
      strings.push(
        Math.floor(seconds).toString() + options.space + options.second
      );
    }
  ...
  if (
    typeof netdataServerStatic !== "undefined" &&
    netdataServerStatic !== null &&
    netdataServerStatic !== ""
  ) {
  ...
  NETDATA.sparkline_js =
    NETDATA.serverStatic + "lib/jquery.sparkline-2.1.2.min.js";
  NETDATA.easypiechart_js =
    NETDATA.serverStatic + "lib/jquery.easypiechart-97b5824.min.js";
  ...
  NETDATA.dygraph_smooth_js =
    NETDATA.serverStatic + "lib/dygraph-smooth-plotter-c91c859.js";
  ...
  NETDATA.errorCodes = {
    ...
    406: {
      message: "Invalid charts index downloaded from server",
      alert: true,
    },
    407: { message: "Cannot HELLO netdata server", alert: false },
    408: {
      message: "Netdata servers sent invalid response to HELLO",
      alert: false,
    },
    409: { message: "Cannot ACCESS netdata registry", alert: false },
    410: { message: "Netdata registry ACCESS failed", alert: false },
    411: {
      message: "Netdata registry server send invalid response to DELETE ",
      alert: false,
    },
    412: { message: "Netdata registry DELETE failed", alert: false },
    413: {
      message: "Netdata registry server send invalid response to SWITCH ",
      alert: false,
    },
    ...
    417: {
      message: "Netdata registry server send invalid response to SEARCH ",
      alert: false,
    },
  ...
  NETDATA.error = function (code, msg) {
    ...
    console.log(
      "ERROR " + code + ": " + NETDATA.errorCodes[code].message + ": " + msg
    );
  ...
  NETDATA.xss = {
    ...
    enabled_for_data:
      typeof netdataCheckXSS === "undefined" ? false : netdataCheckXSS,
        ...
        case "object":
          ...
          if (Array.isArray(obj)) {
            ...
            for (var i in obj) {
              ...
              if (this.string(i) !== i) {
                console.log(
                  'XSS protection removed invalid object member "' +
                    name +
                    "." +
                    i +
                    '"'
  ...
  NETDATA.unitsConversion = {
    ...
    convertibleUnits: {
      ...
      milliseconds: {
        ...
        seconds: {
          check: function (max) {
            return (
              NETDATA.options.current.seconds_as_time &&
              max >= 1000 &&
              max < 60000
            );
          },
          convert: function (milliseconds) {
            ...
            return seconds.toString() + "." + NETDATA.zeropad(milliseconds);
          },
        },
        "M:SS.ms": {
          check: function (max) {
      ...
      nanoseconds: {
        ...
        microseconds: {
          ...
          convert: function (nanoseconds) {
            ...
            return microseconds.toString() + "." + NETDATA.zeropad(nanoseconds);
          },
        },
        milliseconds: {
          check: function (max) {
          ...
          convert: function (nanoseconds) {
            ...
            return milliseconds.toString() + "." + NETDATA.zeropad(nanoseconds);
          },
        },
        seconds: {
          check: function (max) {
          ...
          convert: function (nanoseconds) {
            ...
            return seconds.toString() + "." + NETDATA.zeropad(nanoseconds);
          },
        },
      },
    },
    ...
    seconds2time: function (seconds) {
      ...
      return (
        (days > 0 ? days.toString() + "d:" : "").toString() +
    ...
    get: function (
      ...
      if (
        typeof this.scalableUnits[units] === "undefined" &&
        typeof this.convertibleUnits[units] === "undefined"
      ) {
      ...
      if (
        typeof desired_units === "undefined" ||
        desired_units === null ||
      ...
      if (typeof this.scalableUnits[units] !== "undefined") {
        ...
        if (desired_units === "auto") {
          ...
          if (
            typeof common_units_name === "string" &&
            typeof uuid === "string"
          ) {
        ...
        if (desired_units === "auto") {
          ...
          typeof this.convertibleUnits[units][desired_units] !== "undefined"
        ) {
          switch_units_callback(desired_units);
        ...
        console.log(
          `Unmatched unit conversion method for units ${units.toString()}`
        );
        switch_units_callback(units);
        return function (value) {
          return value;
  ...
  if (
    typeof netdataRegistryAfterMs !== "number" ||
    netdataRegistryAfterMs < 0
  ) {
  ...
  if (typeof netdataRegistry === "undefined") {
    ...
    netdataRegistry =
      typeof netdataNoRegistry !== "undefined" && netdataNoRegistry === false;
  }

  if (
    netdataRegistry === false &&
    typeof netdataRegistryCallback === "function"
  ) {
  ...
  NETDATA.localStorageSet = function (key, value, callback) {
    if (typeof value === "undefined" || value === "undefined") {
      console.log(
        'localStorage: ATTEMPT TO SET UNDEFINED "' +
          key.toString() +
          '" as value ' +
          value +
          " of type " +
  ...
  NETDATA.localStorageGetRecursive = function (obj, prefix, callback) {
    ...
    while (len--) {
      ...
      if (typeof obj[i] === "object") {
        ...
        NETDATA.localStorageGetRecursive(
          obj[i],
          prefix + "." + i.toString(),
          callback
        );
  ...
  NETDATA.setOption = function (key, value) {
    if (key.toString() === "setOptionCallback") {
      ...
      if (
        typeof NETDATA.localStorage.default[name.toString()] === "undefined"
      ) {
        console.log(
          'localStorage: setOption() on unsaved option: "' +
            name.toString() +
            '", value: ' +
            value
        );
      ...
      NETDATA.options.current[key.toString()] = NETDATA.localStorageSet(
        name.toString(),
        value,
        null
      );
  ...
  NETDATA.resetOptions = function () {
    ...
    while (len--) {
      ...
      if (a[0] === "options") {
        ...
        if (
          typeof NETDATA.localStorage.callback[i] === "function" &&
          typeof NETDATA.localStorage.default[i] !== "undefined"
        ) {
  ...
  NETDATA.themes = {
    ...
    slate: {
      bootstrap_css:
        NETDATA.serverStatic + "css/bootstrap-slate-flat-3.3.7.css?v20161229-1",
  ...
  NETDATA.dygraphInitialize = function (callback) {
    if (typeof netdataNoDygraphs === "undefined" || !netdataNoDygraphs) {
      $.ajax({
        ...
        .always(function () {
          if (
            NETDATA.chartLibraries.dygraph.enabled &&
            NETDATA.options.current.smooth_plot
          ) {
  ...
  NETDATA.dygraphChartUpdate = function (state, data) {
    ...
    let options = {
      ...
      visibility: state.dimensions_visibility.selected2BooleanArray(
        state.data.dimension_names
      ),
    };
    ...
    if (state.tmp.dygraph_chart_type === "stacked") {
      if (
        options.includeZero &&
        state.dimensions_visibility.countSelected() < options.visibility.length
      ) {
    ...
    if (state.tmp.dygraph_smooth_eligible) {
      if (
        ...
        (NETDATA.options.current.smooth_plot === false &&
          state.tmp.dygraph_options.plotter === smoothPlotter)
      ) {
    ...
    if (
      netdataSnapshotData !== null &&
      NETDATA.globalPanAndZoom.isActive() &&
      NETDATA.globalPanAndZoom.isMaster(state) === false
    ) {
      // pan and zoom on snapshots
      options.dateWindow = [
        NETDATA.globalPanAndZoom.force_after_ms,
        NETDATA.globalPanAndZoom.force_before_ms,
      ];
      //options.isZoomedIgnoreProgrammaticZoom = true;
    }
    ...
    if (
      oldMin !== null &&
      oldMin > state.tmp.dygraph_instance.axes_[0].extremeRange[0]
    ) {
      state.data.min = state.tmp.dygraph_instance.axes_[0].extremeRange[0];
    ...
    if (
      oldMax !== null &&
      oldMax < state.tmp.dygraph_instance.axes_[0].extremeRange[1]
    ) {
      state.data.max = state.tmp.dygraph_instance.axes_[0].extremeRange[1];
  ...
  NETDATA.dygraphChartCreate = function (state, data) {
    ...
    state.tmp.dygraph_chart_type = NETDATA.dataAttribute(
      state.element,
      "dygraph-type",
    ...
    if (
      ...
      NETDATA.chartLibraries.dygraph.isLogScale(state)
    ) {
      state.tmp.dygraph_chart_type = "area";
    }

    let highlightCircleSize = NETDATA.chartLibraries.dygraph.isSparkline(state)
      ? 3
      : 4;
    ...
    let smooth = NETDATA.dygraph.smooth
      ? NETDATA.dataAttributeBoolean(
          state.element,
          "dygraph-smooth",
          state.tmp.dygraph_chart_type === "line" &&
            NETDATA.chartLibraries.dygraph.isSparkline(state) === false
        )
      : false;

    state.tmp.dygraph_include_zero = NETDATA.dataAttribute(
      state.element,
      "dygraph-includezero",
      state.tmp.dygraph_chart_type === "stacked"
    );
    let drawAxis = NETDATA.dataAttributeBoolean(
      state.element,
      "dygraph-drawaxis",
      true
    );
    ...
    state.tmp.dygraph_options = {
      ...
      showRangeSelector: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-showrangeselector",
        false
      ),
      showRoller: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-showroller",
        false
      ),
      title: NETDATA.dataAttribute(state.element, "dygraph-title", state.title),
      titleHeight: NETDATA.dataAttribute(
        state.element,
        "dygraph-titleheight",
        19
      ),
      ...
      labels: data.result.labels,
      labelsDiv: NETDATA.dataAttribute(
        state.element,
        "dygraph-labelsdiv",
      ...
      labelsSeparateLines: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-labelsseparatelines",
        true
      ),
      labelsShowZeroValues: NETDATA.chartLibraries.dygraph.isLogScale(state)
        ? false
        : NETDATA.dataAttributeBoolean(
            state.element,
            "dygraph-labelsshowzerovalues",
            true
          ),
      labelsKMB: false,
      labelsKMG2: false,
      showLabelsOnHighlight: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-showlabelsonhighlight",
        true
      ),
      hideOverlayOnMouseOut: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-hideoverlayonmouseout",
        true
      ),
      includeZero: state.tmp.dygraph_include_zero,
      ...
      valueRange: NETDATA.dataAttribute(state.element, "dygraph-valuerange", [
        null,
        null,
      ]),
      ylabel: state.units_current, // (state.units_desired === 'auto')?"":state.units_current,
      yLabelWidth: NETDATA.dataAttribute(
        state.element,
        "dygraph-ylabelwidth",
        12
      ),
      ...
      strokeWidth: NETDATA.dataAttribute(
        state.element,
        "dygraph-strokewidth",
        state.tmp.dygraph_chart_type === "stacked"
          ? 0.1
      ...
      strokePattern: NETDATA.dataAttribute(
        state.element,
        "dygraph-strokepattern",
        undefined
      ),
      ...
      drawPoints: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-drawpoints",
        false
      ),
      ...
      drawGapEdgePoints: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-drawgapedgepoints",
        true
      ),
      connectSeparatedPoints: NETDATA.chartLibraries.dygraph.isLogScale(state)
        ? false
        : NETDATA.dataAttributeBoolean(
            state.element,
            "dygraph-connectseparatedpoints",
            false
          ),
      pointSize: NETDATA.dataAttribute(state.element, "dygraph-pointsize", 1),

      // enabling this makes the chart with little square lines
      stepPlot: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-stepplot",
        false
      ),
      ...
      strokeBorderColor: NETDATA.dataAttribute(
        state.element,
        "dygraph-strokebordercolor",
        NETDATA.themes.current.background
      ),
      strokeBorderWidth: NETDATA.dataAttribute(
        state.element,
        "dygraph-strokeborderwidth",
        state.tmp.dygraph_chart_type === "stacked" ? 0.0 : 0.0
      ),
      fillGraph: NETDATA.dataAttribute(
        state.element,
        "dygraph-fillgraph",
        state.tmp.dygraph_chart_type === "area" ||
          state.tmp.dygraph_chart_type === "stacked"
      ),
      fillAlpha: NETDATA.dataAttribute(
        state.element,
        "dygraph-fillalpha",
        state.tmp.dygraph_chart_type === "stacked"
      ...
      stackedGraph: NETDATA.dataAttribute(
        state.element,
        "dygraph-stackedgraph",
        state.tmp.dygraph_chart_type === "stacked"
      ),
      stackedGraphNaNFill: NETDATA.dataAttribute(
        state.element,
        "dygraph-stackedgraphnanfill",
        "none"
      ),
      drawAxis: drawAxis,
      axisLabelFontSize: NETDATA.dataAttribute(
        state.element,
        "dygraph-axislabelfontsize",
        10
      ),
      axisLineColor: NETDATA.dataAttribute(
        state.element,
        "dygraph-axislinecolor",
        NETDATA.themes.current.axis
      ),
      axisLineWidth: NETDATA.dataAttribute(
        state.element,
        "dygraph-axislinewidth",
        1.0
      ),
      drawGrid: NETDATA.dataAttributeBoolean(
        state.element,
        "dygraph-drawgrid",
        true
      ),
      gridLinePattern: NETDATA.dataAttribute(
        state.element,
        "dygraph-gridlinepattern",
        null
      ),
      gridLineWidth: NETDATA.dataAttribute(
        state.element,
        "dygraph-gridlinewidth",
        1.0
      ),
      gridLineColor: NETDATA.dataAttribute(
        state.element,
        "dygraph-gridlinecolor",
        NETDATA.themes.current.grid
      ),
      maxNumberWidth: NETDATA.dataAttribute(
        state.element,
        "dygraph-maxnumberwidth",
        8
      ),
      sigFigs: NETDATA.dataAttribute(state.element, "dygraph-sigfigs", null),
      digitsAfterDecimal: NETDATA.dataAttribute(
        state.element,
        "dygraph-digitsafterdecimal",
        2
      ),
      valueFormatter: NETDATA.dataAttribute(
        state.element,
        "dygraph-valueformatter",
        undefined
      ),
      highlightCircleSize: NETDATA.dataAttribute(
        state.element,
        "dygraph-highlightcirclesize",
        highlightCircleSize
      ),
      highlightSeriesOpts: NETDATA.dataAttribute(
        state.element,
        "dygraph-highlightseriesopts",
        null
      ), // TOO SLOW: { strokeWidth: 1.5 },
      highlightSeriesBackgroundAlpha: NETDATA.dataAttribute(
        state.element,
        "dygraph-highlightseriesbackgroundalpha",
        null
      ), // TOO SLOW: (state.tmp.dygraph_chart_type === 'stacked')?0.7:0.5,
      pointClickCallback: NETDATA.dataAttribute(
        state.element,
        "dygraph-pointclickcallback",
        undefined
      ),
      visibility: state.dimensions_visibility.selected2BooleanArray(
        state.data.dimension_names
      ),
      logscale: NETDATA.chartLibraries.dygraph.isLogScale(state)
        ? "y"
        : undefined,

      // Expects a string in the format "<series name>: <style>" where each series is separated by a |
      perSeriesStyle: NETDATA.dataAttribute(
        state.element,
        "dygraph-per-series-style",
        ""
      ),

      axes: {
        x: {
          pixelsPerLabel: NETDATA.dataAttribute(
            state.element,
            "dygraph-xpixelsperlabel",
            50
          ),
          ticker: Dygraph.dateTicker,
          axisLabelWidth: NETDATA.dataAttribute(
            state.element,
            "dygraph-xaxislabelwidth",
            60
          ),
          drawAxis: NETDATA.dataAttributeBoolean(
            state.element,
            "dygraph-drawxaxis",
            drawAxis
          ),
        ...
        y: {
          ...
          pixelsPerLabel: NETDATA.dataAttribute(
            state.element,
            "dygraph-ypixelsperlabel",
            15
          ),
          axisLabelWidth: NETDATA.dataAttribute(
            state.element,
            "dygraph-yaxislabelwidth",
            50
          ),
          drawAxis: NETDATA.dataAttributeBoolean(
            state.element,
          ...
          axisLabelFormatter: function (y) {
            ...
            if (
              state.units_desired === "auto" &&
              typeof old_units !== "undefined" &&
              new_units !== old_units &&
              !NETDATA.chartLibraries.dygraph.isSparkline(state)
            ) {
              // console.log(this);
              ...
              while (len--) {
                ...
                if (
                  typeof this.plugins_[len].plugin.ylabel_div_ !==
                    "undefined" &&
                  this.plugins_[len].plugin.ylabel_div_ !== null &&
                  typeof this.plugins_[len].plugin.ylabel_div_.children !==
                    "undefined" &&
                  this.plugins_[len].plugin.ylabel_div_.children !== null &&
                  typeof this.plugins_[len].plugin.ylabel_div_.children[0]
                    .children !== "undefined" &&
                  this.plugins_[len].plugin.ylabel_div_.children[0].children !==
                    null
                ) {
                  this.plugins_[
                    len
                  ].plugin.ylabel_div_.children[0].children[0].innerHTML =
                    new_units;
              ...
              if (len < 0) {
                state.log(
                  "units discrepancy, but cannot find dygraphs div to change: old = " +
                    old_units +
                    ", new = " +
                    new_units
                );
      ...
      interactionModel: {
        mousedown: function (event, dygraph, context) {
          ...
          if (event.button && event.button === 1) {
            if (event.shiftKey) {
              ...
              state.tmp.dygraph_highlight_after = dygraph.toDataXCoord(
                event.offsetX
              );
        ...
        mouseup: function (event, dygraph, context) {
          ...
          if (state.tmp.dygraph_highlight_after !== null) {
            ...
            NETDATA.globalChartUnderlay.set(
              state,
        ...
        wheel: function (event, dygraph, context) {
          ...
          if (event.altKey || event.shiftKey) {
            ...
            let percentages = offsetToPercentage(
              dygraph,
              event.offsetX,
              event.offsetY
            );
        ...
        touchend: function (event, dygraph, context) {
          ...
          if (
            ...
            let pct =
              (state.dygraph_last_touch_page_x -
                (dygraph.plotter_.area.x +
                  state.element.getBoundingClientRect().left)) /
              dygraph.plotter_.area.w;
            console.log("pct: " + pct.toString());

            let t = Math.round(
              state.view_after + (state.view_before - state.view_after) * pct
            );
    ...
    if (NETDATA.chartLibraries.dygraph.isLogScale(state)) {
      if (
        Array.isArray(state.tmp.dygraph_options.valueRange) &&
        state.tmp.dygraph_options.valueRange[0] <= 0
      ) {
    ...
    if (
      ...
      // pan and zoom on snapshots
      state.tmp.dygraph_options.dateWindow = [
        NETDATA.globalPanAndZoom.force_after_ms,
        NETDATA.globalPanAndZoom.force_before_ms,
      ];
    ...
    if (
      state.tmp.dygraph_options.valueRange[0] === null &&
      state.tmp.dygraph_options.valueRange[1] === null
    ) {
      if (
        typeof state.tmp.dygraph_instance.axes_[0].extremeRange !== "undefined"
      ) {
        state.tmp.__commonMin = NETDATA.dataAttribute(
          state.element,
          "common-min",
          null
        );
        state.tmp.__commonMax = NETDATA.dataAttribute(
          state.element,
          "common-max",
          null
        );
  ...
  NETDATA.sparklineChartCreate = function (state, data) {
    ...
    let lineColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-linecolor",
      state.chartCustomColors()[0]
    );
    let fillColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-fillcolor",
      state.chart.chart_type === "line"
        ? NETDATA.themes.current.background
        : NETDATA.colorLuminance(
            lineColor,
            NETDATA.chartDefaults.fill_luminance
          )
    );
    let chartRangeMin = NETDATA.dataAttribute(
      state.element,
      "sparkline-chartrangemin",
      undefined
    );
    let chartRangeMax = NETDATA.dataAttribute(
      state.element,
      "sparkline-chartrangemax",
      undefined
    );
    let composite = NETDATA.dataAttribute(
      state.element,
      "sparkline-composite",
      undefined
    );
    let enableTagOptions = NETDATA.dataAttribute(
      state.element,
      "sparkline-enabletagoptions",
      undefined
    );
    let tagOptionPrefix = NETDATA.dataAttribute(
      state.element,
      "sparkline-tagoptionprefix",
      undefined
    );
    let tagValuesAttribute = NETDATA.dataAttribute(
      state.element,
      "sparkline-tagvaluesattribute",
      undefined
    );
    let disableHiddenCheck = NETDATA.dataAttribute(
      state.element,
      "sparkline-disablehiddencheck",
      undefined
    );
    let defaultPixelsPerValue = NETDATA.dataAttribute(
      state.element,
      "sparkline-defaultpixelspervalue",
      undefined
    );
    let spotColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-spotcolor",
      undefined
    );
    let minSpotColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-minspotcolor",
      undefined
    );
    let maxSpotColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-maxspotcolor",
      undefined
    );
    let spotRadius = NETDATA.dataAttribute(
      state.element,
      "sparkline-spotradius",
      undefined
    );
    let valueSpots = NETDATA.dataAttribute(
      state.element,
      "sparkline-valuespots",
      undefined
    );
    let highlightSpotColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-highlightspotcolor",
      undefined
    );
    let highlightLineColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-highlightlinecolor",
      undefined
    );
    let lineWidth = NETDATA.dataAttribute(
      state.element,
      "sparkline-linewidth",
      undefined
    );
    let normalRangeMin = NETDATA.dataAttribute(
      state.element,
      "sparkline-normalrangemin",
      undefined
    );
    let normalRangeMax = NETDATA.dataAttribute(
      state.element,
      "sparkline-normalrangemax",
      undefined
    );
    let drawNormalOnTop = NETDATA.dataAttribute(
      state.element,
      "sparkline-drawnormalontop",
      undefined
    );
    let xvalues = NETDATA.dataAttribute(
      state.element,
      "sparkline-xvalues",
      undefined
    );
    let chartRangeClip = NETDATA.dataAttribute(
      state.element,
      "sparkline-chartrangeclip",
      undefined
    );
    let chartRangeMinX = NETDATA.dataAttribute(
      state.element,
      "sparkline-chartrangeminx",
      undefined
    );
    let chartRangeMaxX = NETDATA.dataAttribute(
      state.element,
      "sparkline-chartrangemaxx",
      undefined
    );
    let disableInteraction = NETDATA.dataAttributeBoolean(
      state.element,
      "sparkline-disableinteraction",
      false
    );
    let disableTooltips = NETDATA.dataAttributeBoolean(
      state.element,
      "sparkline-disabletooltips",
      false
    );
    let disableHighlight = NETDATA.dataAttributeBoolean(
      state.element,
      "sparkline-disablehighlight",
      false
    );
    let highlightLighten = NETDATA.dataAttribute(
      state.element,
      "sparkline-highlightlighten",
      1.4
    );
    let highlightColor = NETDATA.dataAttribute(
      state.element,
      "sparkline-highlightcolor",
      undefined
    );
    let tooltipContainer = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipcontainer",
      undefined
    );
    let tooltipClassname = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipclassname",
      undefined
    );
    let tooltipFormat = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipformat",
      undefined
    );
    let tooltipPrefix = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipprefix",
      undefined
    );
    let tooltipSuffix = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipsuffix",
      " " + state.units_current
    );
    let tooltipSkipNull = NETDATA.dataAttributeBoolean(
      state.element,
      "sparkline-tooltipskipnull",
      true
    );
    let tooltipValueLookups = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipvaluelookups",
      undefined
    );
    let tooltipFormatFieldlist = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipformatfieldlist",
      undefined
    );
    let tooltipFormatFieldlistKey = NETDATA.dataAttribute(
      state.element,
      "sparkline-tooltipformatfieldlistkey",
      undefined
    );
    let numberFormatter = NETDATA.dataAttribute(
      state.element,
      "sparkline-numberformatter",
      function (n) {
        return n.toFixed(2);
      }
    );
    let numberDigitGroupSep = NETDATA.dataAttribute(
      state.element,
      "sparkline-numberdigitgroupsep",
      undefined
    );
    let numberDecimalMark = NETDATA.dataAttribute(
      state.element,
      "sparkline-numberdecimalmark",
      undefined
    );
    let numberDigitGroupCount = NETDATA.dataAttribute(
      state.element,
      "sparkline-numberdigitgroupcount",
      undefined
    );
    let animatedZooms = NETDATA.dataAttributeBoolean(
      state.element,
      "sparkline-animatedzooms",
      false
    );
  ...
  NETDATA.googleInitialize = function (callback) {
    if (
      typeof netdataNoGoogleCharts === "undefined" ||
      !netdataNoGoogleCharts
    ) {
      $.ajax({
  ...
  NETDATA.googleChartCreate = function (state, data) {
    ...
    switch (state.chart.chart_type) {
      case "area":
        ...
        state.google_options.areaOpacity =
          NETDATA.options.current.color_fill_opacity_area;
        state.google_instance = new google.visualization.AreaChart(
          state.element_chart
        );
        break;
      ...
      case "line":
        ...
        state.google_instance = new google.visualization.LineChart(
          state.element_chart
        );
        break;
    }
  ...
  NETDATA.gaugeClearSelection = function (state, force) {
    if (
      typeof state.tmp.gaugeEvent !== "undefined" &&
      typeof state.tmp.gaugeEvent.timer !== "undefined"
    ) {
  ...
  NETDATA.gaugeSetSelection = function (state, t) {
    ...
    let min =
      state.tmp.gaugeMin === null
        ? NETDATA.commonMin.get(state)
        : state.tmp.gaugeMin;
    let max =
      state.tmp.gaugeMax === null
        ? NETDATA.commonMax.get(state)
        : state.tmp.gaugeMax;
    ...
    if (state.tmp.gaugeEvent.timer === undefined) {
      ...
      state.tmp.gaugeEvent.timer = NETDATA.timeout.set(function () {
        ...
        NETDATA.gaugeSet(
          state,
          state.tmp.gaugeEvent.value,
          state.tmp.gaugeEvent.min,
          state.tmp.gaugeEvent.max
        );
      }, 0);
    }
  ...
  NETDATA.gaugeChartCreate = function (state, data) {
    ...
    let pointerColor = NETDATA.dataAttribute(
      state.element,
      "gauge-pointer-color",
      NETDATA.themes.current.gauge_pointer
    );
    let strokeColor = NETDATA.dataAttribute(
      state.element,
      "gauge-stroke-color",
      NETDATA.themes.current.gauge_stroke
    );
    let startColor = NETDATA.dataAttribute(
      state.element,
      "gauge-start-color",
      state.chartCustomColors()[0]
    );
    let stopColor = NETDATA.dataAttribute(
      state.element,
      "gauge-stop-color",
      void 0
    );
    let generateGradient = NETDATA.dataAttribute(
      state.element,
      "gauge-generate-gradient",
      false
    );
    ...
    if (generateGradient.constructor === Array) {
      ...
      while (len--) {
        ...
        let color = NETDATA.dataAttribute(
          state.element,
          "gauge-gradient-percent-color-" + pcent.toString(),
          false
        );
        if (color !== false) {
          let a = [];
      ...
      NETDATA.themes.current.gauge_gradient
    ) {
    ...
    state.tmp.gaugeChartMin.style.fontSize =
      Math.round(valuefontsize * 0.75).toString() + "px";
    ...
    state.tmp.gaugeChartMax.style.fontSize =
      Math.round(valuefontsize * 0.75).toString() + "px";
    ...
    state.tmp.gauge_instance = new Gauge(state.tmp.gauge_canvas).setOptions(
      options
    ); // create sexy gauge!
    ...
    state.legendSetUnitsString = function (units) {
      if (
        typeof state.tmp.gaugeChartUnits !== "undefined" &&
  ...
  NETDATA.easypiechartPercentFromValueMinMax = function (
    state,
    value,
    min,
    max
  ...
  NETDATA.easypiechartInitialize = function (callback) {
    if (
      typeof netdataNoEasyPieChart === "undefined" ||
      !netdataNoEasyPieChart
    ) {
      $.ajax({
  ...
  NETDATA.easypiechartClearSelection = function (state, force) {
    if (
      typeof state.tmp.easyPieChartEvent !== "undefined" &&
      typeof state.tmp.easyPieChartEvent.timer !== "undefined"
    ) {
  ...
  NETDATA.easypiechartSetSelection = function (state, t) {
    ...
    let min =
      state.tmp.easyPieChartMin === null
        ? NETDATA.commonMin.get(state)
        : state.tmp.easyPieChartMin;
    let max =
      state.tmp.easyPieChartMax === null
        ? NETDATA.commonMax.get(state)
        : state.tmp.easyPieChartMax;
    let pcent = NETDATA.easypiechartPercentFromValueMinMax(
      state,
      value,
      min,
      max
    ...
    if (state.tmp.easyPieChartEvent.timer === undefined) {
      ...
      state.tmp.easyPieChartEvent.timer = NETDATA.timeout.set(function () {
        state.tmp.easyPieChartEvent.timer = undefined;
        state.tmp.easyPieChart_instance.update(
          state.tmp.easyPieChartEvent.pcent
        );
      }, 0);
    }
    ...
    if (
      ...
      max =
        state.tmp.easyPieChartMax === null
          ? NETDATA.commonMax.get(state)
          : state.tmp.easyPieChartMax;
      pcent = NETDATA.easypiechartPercentFromValueMinMax(
        state,
        value,
        min,
        max
  ...
  NETDATA.easypiechartChartCreate = function (state, data) {
    ...
    let value = data.result[0];
    let min = NETDATA.dataAttribute(
      state.element,
      "easypiechart-min-value",
      null
    );
    let max = NETDATA.dataAttribute(
      state.element,
      "easypiechart-max-value",
      null
    );
    ...
    let unitfontsize = Math.round(titlefontsize * 0.9);
    let unittop = Math.round(
      valuetop + (valuefontsize + unitfontsize) + size / 40
    );
    ...
    let barColor = NETDATA.dataAttribute(
      state.element,
    ...
    chart.easyPieChart({
      barColor: barColor,
      trackColor: NETDATA.dataAttribute(
        state.element,
        "easypiechart-trackcolor",
        NETDATA.themes.current.easypiechart_track
      ),
      scaleColor: NETDATA.dataAttribute(
        state.element,
        "easypiechart-scalecolor",
        NETDATA.themes.current.easypiechart_scale
      ),
      scaleLength: NETDATA.dataAttribute(
        state.element,
        "easypiechart-scalelength",
        5
      ),
      lineCap: NETDATA.dataAttribute(
        state.element,
        "easypiechart-linecap",
        "round"
      ),
      lineWidth: NETDATA.dataAttribute(
        state.element,
        "easypiechart-linewidth",
        stroke
      ),
      trackWidth: NETDATA.dataAttribute(
        state.element,
        "easypiechart-trackwidth",
        undefined
      ),
      ...
      animate: NETDATA.dataAttribute(state.element, "easypiechart-animate", {
        duration: 500,
        enabled: true,
      }),
      easing: NETDATA.dataAttribute(
        state.element,
        "easypiechart-easing",
        undefined
      ),
    ...
    state.legendSetUnitsString = function (units) {
      if (
        typeof state.tmp.easyPieChartUnits !== "undefined" &&
        state.tmp.units !== units
      ) {
  ...
  NETDATA.d3pieSetContent = function (state, data, index) {
    state.legendFormatValueDecimalsFromMinMax(data.min, data.max);
  ...
  NETDATA.d3pieSetSelection = function (state, t) {
    ...
    if (state.tmp.d3pie_timer === undefined) {
      state.tmp.d3pie_timer = NETDATA.timeout.set(function () {
        ...
        NETDATA.d3pieChange(
          state,
          NETDATA.d3pieSetContent(state, state.data, slot),
          NETDATA.d3pieDateRange(state, state.data, slot)
        );
      }, 0);
    }
  ...
  NETDATA.d3pieClearSelection = function (state, force) {
    ...
    if (state.isAutoRefreshable() && state.data !== null && force !== true) {
      ...
      if (state.tmp.d3pie_last_slot !== -1) {
        ...
        NETDATA.d3pieChange(
          state,
          [{ label: "no data", value: 1, color: "#666666" }],
          "no data available"
        );
      }
    }
  ...
  NETDATA.d3pieChartUpdate = function (state, data) {
    return NETDATA.d3pieChange(
      state,
      NETDATA.d3pieSetContent(state, data, 0),
      NETDATA.d3pieDateRange(state, data, 0)
    );
  };
  ...
  NETDATA.d3pieChartCreate = function (state, data) {
    ...
    state.d3pie_forced_title = NETDATA.dataAttribute(
      state.element,
      "d3pie-title",
      null
    );
    state.d3pie_forced_subtitle = NETDATA.dataAttribute(
      state.element,
      "d3pie-subtitle",
      null
    );
    state.d3pie_forced_footer = NETDATA.dataAttribute(
      state.element,
      "d3pie-footer",
      null
    );
    ...
    state.d3pie_options = {
      header: {
        title: {
          text:
            state.d3pie_forced_title !== null
              ? state.d3pie_forced_title
              : state.title,
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-title-color",
            NETDATA.themes.current.d3pie.title
          ),
          fontSize: NETDATA.dataAttribute(
            state.element,
            "d3pie-title-fontsize",
            12
          ),
          fontWeight: NETDATA.dataAttribute(
            state.element,
            "d3pie-title-fontweight",
            "bold"
          ),
          font: NETDATA.dataAttribute(
            state.element,
            "d3pie-title-font",
            "arial"
          ),
        ...
        subtitle: {
          text:
            state.d3pie_forced_subtitle !== null
              ? state.d3pie_forced_subtitle
              : state.units_current,
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-subtitle-color",
            NETDATA.themes.current.d3pie.subtitle
          ),
          fontSize: NETDATA.dataAttribute(
            state.element,
            "d3pie-subtitle-fontsize",
            10
          ),
          fontWeight: NETDATA.dataAttribute(
            state.element,
            "d3pie-subtitle-fontweight",
            "normal"
          ),
          font: NETDATA.dataAttribute(
            state.element,
      ...
      footer: {
        text:
          state.d3pie_forced_footer !== null
            ? state.d3pie_forced_footer
            : NETDATA.d3pieDateRange(state, data, 0),
        color: NETDATA.dataAttribute(
          state.element,
          "d3pie-footer-color",
          NETDATA.themes.current.d3pie.footer
        ),
        fontSize: NETDATA.dataAttribute(
          state.element,
          "d3pie-footer-fontsize",
          9
        ),
        fontWeight: NETDATA.dataAttribute(
          state.element,
          "d3pie-footer-fontweight",
          "bold"
        ),
        font: NETDATA.dataAttribute(
          state.element,
        ...
        location: NETDATA.dataAttribute(
          state.element,
          "d3pie-footer-location",
          "bottom-center"
      ...
      size: {
        ...
        pieInnerRadius: NETDATA.dataAttribute(
          state.element,
          "d3pie-pieinnerradius",
          "45%"
        ),
        pieOuterRadius: NETDATA.dataAttribute(
          state.element,
          "d3pie-pieouterradius",
          "80%"
        ),
      },
      data: {
        // none, random, value-asc, value-desc, label-asc, label-desc
        sortOrder: NETDATA.dataAttribute(
          state.element,
          "d3pie-sortorder",
          "value-desc"
        ),
        smallSegmentGrouping: {
          enabled: NETDATA.dataAttributeBoolean(
            state.element,
            "d3pie-smallsegmentgrouping-enabled",
            false
          ),
          value: NETDATA.dataAttribute(
            state.element,
            "d3pie-smallsegmentgrouping-value",
            1
          ),
          // percentage, value
          valueType: NETDATA.dataAttribute(
            state.element,
            "d3pie-smallsegmentgrouping-valuetype",
            "percentage"
          ),
          label: NETDATA.dataAttribute(
            state.element,
            "d3pie-smallsegmentgrouping-label",
            "other"
          ),
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-smallsegmentgrouping-color",
            NETDATA.themes.current.d3pie.other
          ),
        },
      ...
      labels: {
        outer: {
          ...
          format: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-outer-format",
            "label-value1"
          ),
          hideWhenLessThanPercentage: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-outer-hidewhenlessthanpercentage",
            null
          ),
          pieDistance: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-outer-piedistance",
            15
          ),
        },
        inner: {
          ...
          format: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-inner-format",
            "percentage"
          ),
          hideWhenLessThanPercentage: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-inner-hidewhenlessthanpercentage",
            2
          ),
        },
        mainLabel: {
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-mainLabel-color",
            NETDATA.themes.current.d3pie.mainlabel
          ), // or 'segment' for dynamic color
          font: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-mainLabel-font",
            "arial"
          ),
          fontSize: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-mainLabel-fontsize",
            10
          ),
          fontWeight: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-mainLabel-fontweight",
            "normal"
          ),
        },
        percentage: {
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-percentage-color",
            NETDATA.themes.current.d3pie.percentage
          ),
          font: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-percentage-font",
            "arial"
          ),
          fontSize: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-percentage-fontsize",
            10
          ),
          fontWeight: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-percentage-fontweight",
            "bold"
          ),
          decimalPlaces: 0,
        },
        value: {
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-value-color",
            NETDATA.themes.current.d3pie.value
          ),
          font: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-value-font",
            "arial"
          ),
          fontSize: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-value-fontsize",
            10
          ),
          fontWeight: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-value-fontweight",
            "bold"
          ),
        },
        lines: {
          enabled: NETDATA.dataAttributeBoolean(
            state.element,
            "d3pie-labels-lines-enabled",
            true
          ),
          style: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-lines-style",
            "curved"
          ),
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-lines-color",
            "segment"
          ), // "segment" or a hex color
        },
        truncation: {
          enabled: NETDATA.dataAttributeBoolean(
            state.element,
            "d3pie-labels-truncation-enabled",
            false
          ),
          truncateLength: NETDATA.dataAttribute(
            state.element,
            "d3pie-labels-truncation-truncatelength",
            30
          ),
        },
      ...
      misc: {
        colors: {
          ...
          segmentStroke: NETDATA.dataAttribute(
            state.element,
            "d3pie-misc-colors-segmentstroke",
            NETDATA.themes.current.d3pie.segment_stroke
          ),
        },
        gradient: {
          enabled: NETDATA.dataAttributeBoolean(
            state.element,
            "d3pie-misc-gradient-enabled",
            false
          ),
          percentage: NETDATA.dataAttribute(
            state.element,
            "d3pie-misc-colors-percentage",
            95
          ),
          color: NETDATA.dataAttribute(
            state.element,
            "d3pie-misc-gradient-color",
            NETDATA.themes.current.d3pie.gradient_color
          ),
        },
        canvasPadding: {
          top: 5,
        ...
        cssPrefix: NETDATA.dataAttribute(
          state.element,
          "d3pie-cssprefix",
          null
        ),
  ...
  NETDATA.peityChartUpdate = function (state, data) {
    ...
    if (state.peity_options.stroke !== state.chartCustomColors()[0]) {
      ...
      if (state.chart.chart_type === "line") {
        ...
        state.peity_options.fill = NETDATA.colorLuminance(
          state.chartCustomColors()[0],
          NETDATA.chartDefaults.fill_luminance
        );
      }
  ...
  NETDATA.textOnlyCreate = function (state, data) {
    var decimalPlaces = NETDATA.dataAttribute(
      state.element,
      "textonly-decimal-places",
      1
    );
  ...
  NETDATA.chartLibraries = {
    dygraph: {
      ...
      resize: function (state) {
        if (
          typeof state.tmp.dygraph_instance !== "undefined" &&
      ...
      options: function (state) {
        return (
          ...
          "%7C" +
          "flip" +
          (this.isLogScale(state) ? "%7C" + "abs" : "").toString()
        );
      },
      legend: function (state) {
        return this.isSparkline(state) === false &&
          NETDATA.dataAttributeBoolean(state.element, "legend", true) === true
          ? "right-side"
          : null;
      },
      ...
      theme: function (state) {
        if (typeof state.tmp.dygraph_theme === "undefined") {
          state.tmp.dygraph_theme = NETDATA.dataAttribute(
            state.element,
            "dygraph-theme",
            "default"
          );
  ...
  NETDATA.commonColors = {
    ...
    prepare: function (state) {
      ...
      if (typeof state.tmp.__commonColors === "undefined") {
        ...
        state.tmp.__commonColors = NETDATA.dataAttribute(
          state.element,
          "common-colors",
          defname
        );
  ...
  NETDATA.onscrollEndDelay = function () {
    NETDATA.options.on_scroll_refresher_stop_until =
      Date.now() +
      (NETDATA.options.current.async_on_scroll
        ? NETDATA.options.current.onscroll_worker_duration_threshold
        : 0);
  };
  ...
  NETDATA.onscroll = function () {
    ...
    NETDATA.onscroll_updater_timeout_id = NETDATA.timeout.set(
      NETDATA.onscrollUpdater,
      0
    );
  ...
  window.addEventListener(
    "resize",
    NETDATA.onresize,
    NETDATA.supportsPassiveEvents() ? { passive: true } : false
  );
  window.addEventListener(
    "scroll",
    NETDATA.onscroll,
  ...
  NETDATA.globalPanAndZoom = {
    ...
    delay: function () {
      ...
      NETDATA.options.auto_refresher_stop_until =
        Date.now() + NETDATA.options.current.global_pan_sync_time;
    },
  ...
  NETDATA.globalChartUnderlay = {
    ...
    init: function (state, after, before, view_after, view_before) {
      ...
      this.after =
        typeof after !== "undefined" && after !== null && after > 0
          ? after
          : null;
      this.before =
        typeof before !== "undefined" && before !== null && before > 0
          ? before
          : null;
      this.view_after =
        typeof view_after !== "undefined" &&
        view_after !== null &&
        view_after > 0
          ? view_after
          : null;
      this.view_before =
        typeof view_before !== "undefined" &&
        view_before !== null &&
        view_before > 0
          ? view_before
          : null;
  ...
  dimensionsVisibility.prototype.dimensionAdd = function (
    label,
    name_div,
    value_div,
    color
    ...
    if (typeof this.dimensions[label] === "undefined") {
      this.len++;
      this.dimensions[label] = new dimensionStatus(
        this,
        label,
        name_div,
        value_div,
  ...
  NETDATA.dateTime = {
    ...
    init: function (timezone) {
      ...
      try {
        NETDATA.options.browser_timezone =
      ...
      try {
        ...
        this.xAxisFormat = new Intl.DateTimeFormat(
          navigator.language,
          xAxisOptions
        );
  ...
  NETDATA.globalSelectionSync = {
    ...
    delay: function (ms) {
      if (NETDATA.options.current.sync_selection) {
        ...
        if (typeof ms === "number") {
          ...
          this.dontSyncBefore =
            Date.now() + NETDATA.options.current.sync_selection_delay;
        }
      }
    },
    ...
    sync: function (state, t) {
      ...
      if (NETDATA.options.current.sync_selection) {
        ...
        if (NETDATA.options.debug.globalSelectionSync) {
          console.log(
            "globalSelectionSync.sync(" + state.id + ", " + t.toString() + ")"
          );
        }
        ...
        if (state.foreignElementSelection !== null) {
          state.foreignElementSelection.innerText =
            NETDATA.dateTime.localeDateString(t) +
            " " +
            NETDATA.dateTime.localeTimeString(t);
        }
  ...
  NETDATA.intersectionObserver = {
      ...
      entries.forEach(function (entry) {
        ...
        if (entry.intersectionRatio > 0) {
          ...
          if (idx === -1) {
            ...
            state.log(
              "was not visible until now, but was already in visible_targets"
            );
          }
        } else {
          idx = NETDATA.intersectionObserver.visible_targets.indexOf(state);
    ...
    init: function () {
      if (
        typeof netdataIntersectionObserver === "undefined" ||
        netdataIntersectionObserver
      ) {
        try {
  ...
  let chartState = function (element) {
    ...
    this.log = function (msg) {
      console.log(
        this.id + " (" + this.library_name + " " + this.uuid + "): " + msg
      );
    };
    ...
    this.width = NETDATA.dataAttribute(
      this.element,
      "width",
      NETDATA.chartDefaults.width
    );
    this.height = NETDATA.dataAttribute(
      this.element,
      "height",
      NETDATA.chartDefaults.height
    );
    this.height_original = this.height;

    if (this.settings_id !== null) {
      this.height = NETDATA.localStorageGet(
        "chart_heights." + this.settings_id,
        this.height,
        function (height) {
    ...
    this.library_name = NETDATA.dataAttribute(
      this.element,
      "chart-library",
      NETDATA.chartDefaults.library
    );
    ...
    const lateInitialization = () => {
      ...
      this.host = NETDATA.dataAttribute(
        this.element,
        "host",
        NETDATA.serverDefault
      );
      ...
      this.method = NETDATA.dataAttribute(
        this.element,
        "method",
        NETDATA.chartDefaults.method
      );
      this.gtime = NETDATA.dataAttribute(this.element, "gtime", 0);

      // the time-range requested by the user
      this.after = NETDATA.dataAttribute(
        this.element,
        "after",
        NETDATA.chartDefaults.after
      );
      this.before = NETDATA.dataAttribute(
        this.element,
        "before",
        NETDATA.chartDefaults.before
      );

      // the pixels per point requested by the user
      this.pixels_per_point = NETDATA.dataAttribute(
        this.element,
        "pixels-per-point",
        1
      );
      ...
      this.force_update_every = NETDATA.dataAttribute(
        this.element,
        "update-every",
        null
      );
      if (
        typeof this.force_update_every !== "number" ||
        this.force_update_every <= 1
      ) {
      ...
      this.dimensions = NETDATA.encodeURIComponent(
        NETDATA.dataAttribute(this.element, "dimensions", null)
      );
      ...
      this.units_desired = NETDATA.dataAttribute(
        this.element,
        "desired-units",
        NETDATA.options.current.units
      ); // the units of the chart dimensions
      this.units_current = this.units;
      this.units_common = NETDATA.dataAttribute(
        this.element,
        "common-units",
        null
      );
      ...
      this.append_options = NETDATA.encodeURIComponent(
        NETDATA.dataAttribute(this.element, "append-options", null)
      );

      // override options to pass to netdata
      this.override_options = NETDATA.encodeURIComponent(
        NETDATA.dataAttribute(this.element, "override-options", null)
      );
      ...
      let refresh_dt_element_name = NETDATA.dataAttribute(
        this.element,
        "dt-element-name",
        null
      ); // string - the element to print refresh_dt_ms

      if (refresh_dt_element_name !== null) {
        this.refresh_dt_element =
          document.getElementById(refresh_dt_element_name) || null;
      } else {
      ...
      this.foreignElementUpdateEvery = getForeignElementById(
        "show-update-every-at"
      );
    ...
    const invisibleSearchableText = () => {
      return (
        '<span style="position:absolute; opacity: 0; width: 0px;">' +
        this.id +
        "</span>"
      );
    };
    ...
    const canBeRendered = (uncached_visibility) => {
      ...
      let ret =
        (NETDATA.options.page_is_visible ||
          ...
          this.updates_since_last_unhide === 0) &&
        isHidden() === false &&
        this.isVisible(uncached_visibility);
    ...
    const resizeChartToHeight = (h) => {
      ...
      NETDATA.options.auto_refresher_stop_until =
        now + NETDATA.options.current.stop_updates_while_resizing;
    ...
    this.resizeForPrint = function () {
      if (
        typeof this.element_legend_childs !== "undefined" &&
        this.element_legend_childs.perfect_scroller !== null
      ) {
    ...
    this.resizeHandler = function (e) {
      ...
      if (
        typeof this.event_resize === "undefined" ||
      ...
      let now = Date.now();
      if (
        now - this.event_resize.last <=
          NETDATA.options.current.double_click_speed &&
        this.element_legend_childs.perfect_scroller !== null
      ) {
        ...
        let optimal =
          this.event_resize.chart_last_h +
          this.element_legend_childs.perfect_scroller.scrollHeight -
          this.element_legend_childs.perfect_scroller.clientHeight;
        ...
        // reset to the original/saved height
          ...
          this.event_resize.chart_last_h !== this.event_resize.chart_original_h
        ) {
          ...
          resizeChartToHeight(
            this.event_resize.chart_original_h.toString() + "px"
          );
        }
        ...
        // reset to the internal default height
          ...
          this.event_resize.chart_last_h.toString() + "px" !==
        ...
        // resize to it
          ...
          typeof this.element_legend_childs.perfect_scroller.firstChild !==
          "undefined"
        ) {
          let parent_rect = this.element.getBoundingClientRect();
          let content_rect =
            this.element_legend_childs.perfect_scroller.firstElementChild.getBoundingClientRect();
          let wanted =
            content_rect.top -
            parent_rect.top +
            this.element_legend_childs.perfect_scroller.firstChild
              .clientHeight +
            18; // 15 = toolbox + 3 space
        ...
        document.onmousemove =
          ...
          this.element_legend_childs.resize_handler.ontouchmove =
            function (e) {
              ...
              if (y !== null) {
                let newH =
                  that.event_resize.chart_start_h +
                  y -
                  that.event_resize.mouse_start_y;
    ...
    this.resetChart = function (dontClearMaster, dontUpdate) {
      if (this.debug) {
        this.log(
          "resetChart(" + dontClearMaster + ", " + dontUpdate + ") called"
        );
      }
    ...
    this.updateChartPanOrZoom = function (after, before, callback) {
      ...
      if (typeof this.fixed_min_duration === "undefined") {
        this.fixed_min_duration = Math.round(
          (this.chartWidth() / 30) * this.chart.update_every * 1000
        );
      }
      ...
      // and we zoom
      if (
        wanted_duration < current_duration &&
        wanted_duration < min_duration
      ) {
        if (this.debug) {
          this.log(
            logme +
              "too small: min_duration: " +
              (min_duration / 1000).toString() +
              ", wanted: " +
              (wanted_duration / 1000).toString()
          );
        }
      ...
      if (
        Math.abs(current_duration - wanted_duration) <= tolerance &&
        movement <= tolerance &&
        ret
      ) {
        if (this.debug) {
          this.log(
            logme +
              "REJECTING UPDATE: current/min duration: " +
              (current_duration / 1000).toString() +
              "/" +
              (this.fixed_min_duration / 1000).toString() +
              ", wanted duration: " +
              (wanted_duration / 1000).toString() +
              ", duration diff: " +
              Math.round(
                Math.abs(current_duration - wanted_duration) / 1000
              ).toString() +
              ", movement: " +
              (movement / 1000).toString() +
              ", tolerance: " +
              (tolerance / 1000).toString() +
              ", returning: " +
              false
          );
        }
      ...
      if (this.debug) {
        this.log(
          logme +
            "ACCEPTING UPDATE: current/min duration: " +
            (current_duration / 1000).toString() +
            "/" +
            (this.fixed_min_duration / 1000).toString() +
            ", wanted duration: " +
      ...
      this.current.force_update_at =
        Date.now() + NETDATA.options.current.pan_and_zoom_delay;
    ...
    this.unitsConversionSetup = function (min, max) {
      if (
        this.units !== _unitsConversionLastUnits ||
        ...
        _unitsConversion = NETDATA.unitsConversion.get(
          this.uuid,
          min,
          max,
          this.units,
    ...
    this.legendFormatValueDecimalsFromMinMax = function (min, max) {
      if (
        min === _legendFormatValueChartDecimalsLastMin &&
        max === _legendFormatValueChartDecimalsLastMax
      ) {
        return;
      }
    ...
    this.legendSetDateString = function (date) {
      if (
        this.element_legend_childs.title_date !== null &&
        date !== this.tmp.__last_shown_legend_date
      ) {
    ...
    this.legendSetTimeString = function (time) {
      if (
        this.element_legend_childs.title_time !== null &&
        time !== this.tmp.__last_shown_legend_time
      ) {
    ...
    this.legendSetUnitsString = function (units) {
      if (
        this.element_legend_childs.title_units !== null &&
        units !== this.tmp.__last_shown_legend_units
      ) {
      ...
      if (this.data && this.element_legend_childs.series !== null) {
        ...
        while (i--) {
          ...
          if (
            ...
            typeof this.element_legend_childs.series[label] === "undefined"
          ) {
            continue;
          }
    ...
    this.legendShowLatestValues = function () {
      ...
      if (
        Math.abs(this.netdata_last - this.view_before) <= this.data_update_every
      ) {
    ...
    this.legendPluginModuleString = function (withContext) {
      ...
      if (typeof this.chart !== "undefined") {
        ...
        if (typeof this.chart.plugin === "string" && this.chart.plugin !== "") {
          ...
          if (
            typeof this.chart.module === "string" &&
            this.chart.module !== ""
          ) {
    ...
    this.legendResolutionTooltip = function () {
      ...
      return (
        "resolution " +
        NETDATA.seconds4human(viewed) +
        ", collected every " +
        NETDATA.seconds4human(collected)
      );
    };
    ...
    this.legendUpdateDOM = function () {
      ...
      if (
        typeof this.element_legend_childs.series !== "object" ||
        this.element_legend_childs.series === null
      ) {
        ...
        typeof this.element_legend_childs.series.labels_key === "undefined"
      ) {
        needed = true;
      } else {
        ...
        if (labels !== this.element_legend_childs.series.labels_key) {
          ...
          if (this.debug) {
            this.log(
              'NEW LABELS: "' +
                labels +
                '" NOT EQUAL OLD LABELS: "' +
                this.element_legend_childs.series.labels_key +
                '"'
            );
          }
        }
      ...
      if (!needed) {
        ...
        if (
          Math.abs(this.netdata_last - this.view_before) <=
          this.data_update_every
        ) {
          if (this.debug) {
            this.log(
              "chart is in latest position... updating values on legend..."
            );
          }
      ...
      const genLabel = function (state, parent, dim, name, count) {
        ...
        let user_id = NETDATA.dataAttribute(
          state.element,
          "show-value-of-" + name.toLowerCase() + "-at",
          null
        );
        if (user_id === null) {
          user_id = NETDATA.dataAttribute(
            state.element,
            "show-value-of-" + dim.toLowerCase() + "-at",
            null
          );
        }
        if (user_id !== null) {
        ...
        state.dimensions_visibility.dimensionAdd(
          name,
          label.name,
          label.value,
          color
        ...
        label.name.innerHTML =
          '<table class="netdata-legend-name-table-' +
          state.chart.chart_type +
          ...
          rgb.b +
          "," +
          NETDATA.options.current[
            "color_fill_opacity_" + state.chart.chart_type
          ] +
          ") !important" +
      ...
      if (this.element_chart === null) {
        ...
        if (this.hasLegend()) {
          this.element_chart.className =
            "netdata-chart-with-legend-right netdata-" +
            this.library_name +
            "-chart-with-legend-right";
        } else {
          this.element_chart.className =
            " netdata-chart netdata-" + this.library_name + "-chart";
        }
      }
      ...
      if (this.hasLegend()) {
        if (this.element_legend === null) {
          ...
          this.element_legend.className =
            "netdata-chart-legend netdata-" + this.library_name + "-legend";
        ...
        if (
          NETDATA.options.current.legend_toolbox &&
          this.library.toolboxPanAndZoom !== null
        ) {
          this.element_legend_childs.toolbox = document.createElement("div");
          this.element_legend_childs.toolbox_left =
            document.createElement("div");
          this.element_legend_childs.toolbox_right =
            document.createElement("div");
          this.element_legend_childs.toolbox_reset =
            document.createElement("div");
          this.element_legend_childs.toolbox_zoomin =
            document.createElement("div");
          this.element_legend_childs.toolbox_zoomout =
            document.createElement("div");
          this.element_legend_childs.toolbox_volume =
            document.createElement("div");

          const getPanAndZoomStep = function (event) {
            if (event.ctrlKey) {
              return (
                NETDATA.options.current.pan_and_zoom_factor *
                NETDATA.options.current.pan_and_zoom_factor_multiplier_control
              );
            } else if (event.shiftKey) {
              return (
                NETDATA.options.current.pan_and_zoom_factor *
                NETDATA.options.current.pan_and_zoom_factor_multiplier_shift
              );
            } else if (event.altKey) {
              return (
                NETDATA.options.current.pan_and_zoom_factor *
                NETDATA.options.current.pan_and_zoom_factor_multiplier_alt
              );
            } else {
          ...
          this.element_legend_childs.toolbox.className +=
            " netdata-legend-toolbox";
          this.element.appendChild(this.element_legend_childs.toolbox);

          this.element_legend_childs.toolbox_left.className +=
            " netdata-legend-toolbox-button";
          this.element_legend_childs.toolbox_left.innerHTML =
            NETDATA.icons.left;
          this.element_legend_childs.toolbox.appendChild(
            this.element_legend_childs.toolbox_left
          );
          this.element_legend_childs.toolbox_left.onclick = function (e) {
            ...
            let step =
              (that.view_before - that.view_after) * getPanAndZoomStep(e);
          ...
          if (NETDATA.options.current.show_help) {
            $(this.element_legend_childs.toolbox_left).popover({
              ...
              title: "Pan Left",
              content:
                "Pan the chart to the left. You can also <b>drag it</b> with your mouse or your finger (on touch devices).<br/><small>Help can be disabled from the settings.</small>",
            });
          }

          this.element_legend_childs.toolbox_reset.className +=
            " netdata-legend-toolbox-button";
          this.element_legend_childs.toolbox_reset.innerHTML =
            NETDATA.icons.reset;
          this.element_legend_childs.toolbox.appendChild(
            this.element_legend_childs.toolbox_reset
          );
          ...
          if (NETDATA.options.current.show_help) {
            $(this.element_legend_childs.toolbox_reset).popover({
              ...
              title: "Chart Reset",
              content:
                "Reset all the charts to their default auto-refreshing state. You can also <b>double click</b> the chart contents with your mouse or your finger (on touch devices).<br/><small>Help can be disabled from the settings.</small>",
            });
          }

          this.element_legend_childs.toolbox_right.className +=
            " netdata-legend-toolbox-button";
          this.element_legend_childs.toolbox_right.innerHTML =
            NETDATA.icons.right;
          this.element_legend_childs.toolbox.appendChild(
            this.element_legend_childs.toolbox_right
          );
          ...
          if (NETDATA.options.current.show_help) {
            $(this.element_legend_childs.toolbox_right).popover({
              ...
              title: "Pan Right",
              content:
                "Pan the chart to the right. You can also <b>drag it</b> with your mouse or your finger (on touch devices).<br/><small>Help can be disabled from the settings.</small>",
            });
          }

          this.element_legend_childs.toolbox_zoomin.className +=
            " netdata-legend-toolbox-button";
          this.element_legend_childs.toolbox_zoomin.innerHTML =
            NETDATA.icons.zoomIn;
          this.element_legend_childs.toolbox.appendChild(
            this.element_legend_childs.toolbox_zoomin
          );
          this.element_legend_childs.toolbox_zoomin.onclick = function (e) {
            e.preventDefault();
            let dt =
              ((that.view_before - that.view_after) *
                (getPanAndZoomStep(e) * 0.8)) /
              2;
          ...
          if (NETDATA.options.current.show_help) {
            $(this.element_legend_childs.toolbox_zoomin).popover({
              ...
              title: "Chart Zoom In",
              content:
                "Zoom in the chart. You can also press SHIFT and select an area of the chart, or press SHIFT or ALT and use the mouse wheel or 2-finger touchpad scroll to zoom in or out.<br/><small>Help can be disabled from the settings.</small>",
            });
          }

          this.element_legend_childs.toolbox_zoomout.className +=
            " netdata-legend-toolbox-button";
          this.element_legend_childs.toolbox_zoomout.innerHTML =
            NETDATA.icons.zoomOut;
          this.element_legend_childs.toolbox.appendChild(
            this.element_legend_childs.toolbox_zoomout
          );
          ...
          if (NETDATA.options.current.show_help) {
            $(this.element_legend_childs.toolbox_zoomout).popover({
              ...
              content:
                "Zoom out the chart. You can also press SHIFT or ALT and use the mouse wheel, or 2-finger touchpad scroll to zoom in or out.<br/><small>Help can be disabled from the settings.</small>",
            });
          }
        ...
        if (NETDATA.options.current.resize_charts) {
          this.element_legend_childs.resize_handler =
            document.createElement("div");

          this.element_legend_childs.resize_handler.className +=
            " netdata-legend-resize-handler";
          this.element_legend_childs.resize_handler.innerHTML =
            NETDATA.icons.resize;
          ...
          if (NETDATA.options.current.show_help) {
            $(this.element_legend_childs.resize_handler).popover({
              ...
              title: "Chart Resize",
              content:
                "Drag this point with your mouse or your finger (on touch devices), to resize the chart vertically. You can also <b>double click it</b> or <b>double tap it</b> to reset between 2 states: the default and the one that fits all the values.<br/><small>Help can be disabled from the settings.</small>",
            });
          }
          ...
          // touchstart event
          this.element_legend_childs.resize_handler.addEventListener(
            "touchstart",
            function (e) {
              that.resizeHandler(e);
            },
        ...
        if (this.chart) {
          this.element_legend_childs.title_date.title =
            this.legendPluginModuleString(true);
          this.element_legend_childs.title_time.title =
            this.legendResolutionTooltip();
        }

        this.element_legend_childs.title_date.className +=
        ...
        this.element_legend_childs.title_time.className +=
        ...
        this.element_legend_childs.title_units.className +=
        ...
        this.element_legend_childs.perfect_scroller.className =
          "netdata-legend-series";
        this.element_legend.appendChild(
          this.element_legend_childs.perfect_scroller
        );
        ...
        if (NETDATA.options.current.show_help) {
          $(content).popover({
            ...
            content:
              "You can click or tap on the values or the labels to select dimensions. By pressing SHIFT or CONTROL, you can enable or disable multiple dimensions.<br/><small>Help can be disabled from the settings.</small>",
          });
        }
      } else {
        this.element_legend_childs = {
      ...
      if (this.data) {
        this.element_legend_childs.series.labels_key =
          this.data.dimension_names.toString();
        if (this.debug) {
          this.log(
            'labels from data: "' +
              this.element_legend_childs.series.labels_key +
        ...
        for (let i = 0, len = this.data.dimension_names.length; i < len; i++) {
          genLabel(
            this,
            content,
            this.data.dimension_ids[i],
            this.data.dimension_names[i],
            i
          );
        }
      } else {
    ...
    this.chartURL = function () {
      ...
      if (NETDATA.options.force_data_points !== 0) {
        ...
        this.data_points =
          this.points ||
          Math.round(this.chartWidth() / this.chartPixelsPerPoint());
    ...
    this.updateChartWithData = function (data) {
      ...
      if (
        NETDATA.options.current.pan_and_zoom_data_padding &&
        this.requested_padding !== null
      ) {
      ...
      if (this.debug) {
        ...
        if (this.current.force_after_ms) {
          this.log(
            "STATUS: forced    : " +
              (this.current.force_after_ms / 1000).toString() +
              " - " +
              (this.current.force_before_ms / 1000).toString()
          );
        } else {
        ...
        this.log(
          "STATUS: requested : " +
            (this.requested_after / 1000).toString() +
            " - " +
            (this.requested_before / 1000).toString()
        );
        this.log(
          "STATUS: downloaded: " +
            (this.data_after / 1000).toString() +
            " - " +
            (this.data_before / 1000).toString()
        );
        this.log(
          "STATUS: rendered  : " +
            (this.view_after / 1000).toString() +
            " - " +
            (this.view_before / 1000).toString()
        );
      ...
      if (
        this.updates_since_last_creation >=
        this.library.max_updates_to_recreate()
      ) {
        if (this.debug) {
          this.log(
            "max updates of " +
              this.updates_since_last_creation.toString() +
              " reached. Forcing re-generation."
          );
        }
      ...
      if (NETDATA.globalPanAndZoom.isActive()) {
        ...
        if (
          NETDATA.options.current.parallel_refresher &&
          NETDATA.options.current.concurrent_refreshes &&
          typeof this.force_update_every !== "number"
        ) {
      ...
      if (this.foreignElementBefore !== null) {
        this.foreignElementBefore.innerText =
          NETDATA.dateTime.localeDateString(this.view_before) +
          " " +
          NETDATA.dateTime.localeTimeString(this.view_before);
      }

      if (this.foreignElementAfter !== null) {
        this.foreignElementAfter.innerText =
          NETDATA.dateTime.localeDateString(this.view_after) +
          " " +
          NETDATA.dateTime.localeTimeString(this.view_after);
      }

      if (this.foreignElementDuration !== null) {
        this.foreignElementDuration.innerText = NETDATA.seconds4human(
          Math.floor((this.view_before - this.view_after) / 1000) + 1
        );
      }

      if (this.foreignElementUpdateEvery !== null) {
        this.foreignElementUpdateEvery.innerText = NETDATA.seconds4human(
          Math.floor(this.data_update_every / 1000)
        );
      }
    };
    ...
    this.getSnapshotData = function (key) {
      ...
      let uncompressed;
      try {
        uncompressed = netdataSnapshotData.uncompress(
          netdataSnapshotData.data[key]
        );
        ...
        if (typeof uncompressed === "undefined") {
          this.log(
            "uncompressed snapshot data for key " + key + " is undefined"
          );
          return null;
        }
      } catch (e) {
      ...
      if (typeof uncompressed !== "string") {
        this.log(
          "uncompressed snapshot data for key " + key + " is not string"
        );
        return null;
      }
    ...
    this.updateChart = function (callback) {
      ...
      if (
        NETDATA.statistics.refreshes_active >
        NETDATA.statistics.refreshes_active_max
      ) {
        NETDATA.statistics.refreshes_active_max =
          NETDATA.statistics.refreshes_active;
      }
      ...
      if (netdataSnapshotData !== null) {
        ...
        if (data !== null) {
          ok = true;
          data = NETDATA.xss.checkData(
            "/api/v1/data",
            data,
            this.library.xssRegexIgnore
          );
      ...
      this.xhr = $.ajax({
        ...
        .fail(function (msg) {
          ...
          if (msg.statusText !== "abort") {
            ...
            if (
              that.retries_on_data_failures >
              NETDATA.options.current.retries_on_data_failures
            ) {
    ...
    const __isVisible = function () {
      ...
      if (NETDATA.options.current.update_only_visible !== false) {
        ...
        ret = !(
          rect.width === 0 ||
          rect.height === 0 ||
          chartBottom + tolerance < screenTop ||
          chartTop - tolerance > screenBottom
        );
      }
    ...
    this.isVisible = function (nocache) {
      ...
      if (
        (typeof nocache !== "undefined" && nocache) ||
    ...
    this.canBeAutoRefreshed = function () {
      ...
      if (this.library === null || this.library.enabled === false) {
        ...
        if (this.debug) {
          this.log(
            "canBeAutoRefreshed() -> chart library " +
              this.library_name +
              " is not available"
          );
        }
      ...
      if (
        this.current.force_update_at !== 0 &&
        this.current.force_update_at < now
      ) {
        if (this.debug) {
          this.log(
            "canBeAutoRefreshed() -> timed force update - allowing this update"
          );
        }
      ...
      if (
        ...
        if (NETDATA.options.debug.focus || this.debug) {
          this.log(
            "canBeAutoRefreshed() -> not the first update, and page does not have focus"
          );
        }
      ...
      if (NETDATA.globalPanAndZoom.isActive()) {
        if (NETDATA.globalPanAndZoom.shouldBeAutoRefreshed(this)) {
          ...
          if (this.debug) {
            this.log(
              "canBeAutoRefreshed(): global panning: I am already up to date."
            );
          }
      ...
      if (now - this.tm.last_autorefreshed >= data_update_every) {
        if (this.debug) {
          this.log(
            "canBeAutoRefreshed(): It is time to update me. Now: " +
              now.toString() +
              ", last_autorefreshed: " +
              this.tm.last_autorefreshed +
              ", data_update_every: " +
              data_update_every +
              ", delta: " +
              (now - this.tm.last_autorefreshed).toString()
          );
        }
    ...
    this.__defaultsFromDownloadedChart = function (chart) {
      ...
      this.data_points = Math.round(
        this.chartWidth() / this.chartPixelsPerPoint()
      );
  ...
  NETDATA.chartRefresherNoParallel = function (index, callback) {
    ...
    if (index >= targets.length) {
      ...
      if (
        NETDATA.options.auto_refresher_fast_weight <
        NETDATA.options.current.fast_render_timeframe
      ) {
        if (NETDATA.options.debug.main_loop) {
      ...
      while (len--) {
        ...
        if (!state.library.initialized) {
          if (state.library.enabled) {
            ...
            state.error(
              'chart library "' + state.library_name + '" is not enabled.'
            );
          }
        }
  ...
  NETDATA.parseDom = function (callback) {
    ...
    if (NETDATA.options.debug.main_loop) {
      console.log(
        "DOM updated - there are " + targets.length + " charts on page."
      );
    }
  ...
  NETDATA.alarms = {
    ...
    callback:
      typeof netdataAlarmsActiveCallback === "function"
        ? netdataAlarmsActiveCallback
        : null,
    ...
    notificationCallback:
      typeof netdataAlarmsNotifCallback === "function"
        ? netdataAlarmsNotifCallback
        : null,
    ...
    recipientMatches: function (to_string, wanted_array) {
      if (
        typeof wanted_array === "undefined" ||
        wanted_array === null ||
        Array.isArray(wanted_array) === false
      ) {
        return true;
      }
    ...
    activeForRecipients: function () {
      ...
      for (let x in data.alarms) {
        ...
        if (
          (alarm.status === "WARNING" || alarm.status === "CRITICAL") &&
          NETDATA.alarms.recipientMatches(
            alarm.recipient,
            NETDATA.alarms.recipients
          )
        ) {
          active[x] = alarm;
        }
    ...
    notify: function (entry) {
      ...
      switch (entry.status) {
        ...
        case "CLEAR":
          ...
          if (
            entry.old_status === "UNINITIALIZED" ||
            entry.old_status === "UNDEFINED"
          ) {
      ...
      // filter recipients
      if (show) {
        show = NETDATA.alarms.recipientMatches(
          entry.recipient,
          NETDATA.alarms.recipients
        );
      }
    ...
    scrollToChart: function (chart_id) {
      if (typeof chart_id === "string") {
        let offset = $(
          "#" + NETDATA.alarms.chart_div_id_prefix + NETDATA.name2id(chart_id)
        ).offset();
        if (typeof offset !== "undefined") {
          $("html, body").animate(
            { scrollTop: offset.top + NETDATA.alarms.chart_div_offset },
            NETDATA.alarms.chart_div_animation_duration
          );
          return true;
        }
      }
    ...
    notifyAll: function () {
      ...
      NETDATA.alarms.get_log(
        ...
        function (data) {
          ...
          if (
            typeof netdataAlarmsRemember === "undefined" ||
            netdataAlarmsRemember
          ) {
            NETDATA.localStorageSet(
    ...
    check_notifications: function () {
      ...
      if (
        typeof NETDATA.alarms.current !== "undefined" &&
        typeof NETDATA.alarms.current.alarms === "object"
      ) {
        ...
        if (
          NETDATA.alarms.current.latest_alarm_log_unique_id >
          NETDATA.alarms.last_notification_id
        ) {
    ...
    get: function (what, callback) {
      $.ajax({
        ...
        .done(function (data) {
          data = NETDATA.xss.checkOptional(
            "/api/v1/alarms",
            data /*, '.*\.(calc|calc_parsed|warn|warn_parsed|crit|crit_parsed)$' */
          );

          if (
            NETDATA.alarms.first_notification_id === 0 &&
            typeof data.latest_alarm_log_unique_id === "number"
          ) {
            NETDATA.alarms.first_notification_id =
    ...
    init: function () {
      ...
      if (
        typeof netdataAlarmsRecipients !== "undefined" &&
        Array.isArray(netdataAlarmsRecipients)
      ) {
  ...
  NETDATA.registry = {
    ...
    access: function (max_redirects, callback) {
      ...
      $.ajax({
        url:
          NETDATA.registry.server +
          "/api/v1/registry?action=access&machine=" +
          NETDATA.registry.machine_guid +
          "&name=" +
          encodeURIComponent(name) +
          "&url=" +
          encodeURIComponent(url), // + '&visible_url=' + encodeURIComponent(document.location),
        async: true,
        cache: false,
        headers: {
          "Cache-Control": "no-cache, no-store",
        ...
        .done(function (data) {
          data = NETDATA.xss.checkAlways(
            "/api/v1/registry?action=access",
            data
          );
          ...
          if (data === null) {
            ...
            if (typeof callback === "function") {
              const urls = data.urls.filter(
                (u) => u[1] !== NETDATA.registry.MASKED_DATA
              );
    ...
    delete: function (delete_url, callback) {
      ...
      $.ajax({
        url:
          NETDATA.registry.server +
          "/api/v1/registry?action=delete&machine=" +
          NETDATA.registry.machine_guid +
          "&name=" +
          encodeURIComponent(NETDATA.registry.hostname) +
          "&url=" +
          encodeURIComponent(NETDATA.serverDefault) +
          "&delete_url=" +
          encodeURIComponent(delete_url),
        async: true,
        cache: false,
        headers: {
          "Cache-Control": "no-cache, no-store",
    ...
    search: function (machine_guid, callback) {
      ...
      $.ajax({
        url:
          NETDATA.registry.server +
          "/api/v1/registry?action=search&machine=" +
          NETDATA.registry.machine_guid +
          "&name=" +
          encodeURIComponent(NETDATA.registry.hostname) +
          "&url=" +
    ...
    switch: function (new_person_guid, callback) {
      ...
      $.ajax({
        url:
          NETDATA.registry.server +
          "/api/v1/registry?action=switch&machine=" +
          NETDATA.registry.machine_guid +
          "&name=" +
          encodeURIComponent(NETDATA.registry.hostname) +
          "&url=" +
  ...
  NETDATA.requiredJs = [
    {
      ...
      isAlreadyLoaded: function () {
        ...
        if (typeof $().emulateTransitionEnd === "function") {
          ...
          return (
            typeof netdataNoBootstrap !== "undefined" && netdataNoBootstrap
          );
        }
      },
    },
    {
      ...
      isAlreadyLoaded: function () {
        return (
          typeof netdataNoFontAwesome !== "undefined" && netdataNoFontAwesome
        );
      },
    },
    {
  ...
  NETDATA.loadRequiredJs = function (index, callback) {
    ...
    let async = true;
    if (
      typeof NETDATA.requiredJs[index].async !== "undefined" &&
      NETDATA.requiredJs[index].async === false
    ) {
      async = false;
    }
    ...
    $.ajax({
      ...
      .fail(function () {
        alert(
          "Cannot load required JS library: " + NETDATA.requiredJs[index].url
        );
      })
      .always(function () {
        NETDATA.loadedRequiredJs++;
